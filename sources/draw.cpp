...
void init_lights() {
    GLfloat light0_position[] = {3, 2, 3, 0};
    GLfloat light1_position[] = {-3, 5, -3, 0};
...
static void set_normal_and_vertex(float u, float v, float centerX, float centerY, float centerZ, float radius) {
  glNormal3f(
...
void draw_opponent_figure(int position, float radius, int slices) {
...
void draw_table() {
  ...
  draw_player_figure(1, 0.2, 40);
  draw_player_figure(9, 0.2, 40);
  draw_player_figure(14, 0.2, 40);
  draw_player_figure(22, 0.2, 40);
  draw_opponent_figure(2, 0.2, 40);
  draw_opponent_figure(11, 0.2, 40);
  //draw_opponent_figure(14, 0.2, 40);
  draw_opponent_figure(21, 0.2, 40);
